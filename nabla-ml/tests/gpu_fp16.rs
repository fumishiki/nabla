...
mod cuda_fp16 {
    ...
    fn run_ops<T: Scalar>() {
        ...
        let x1 = make::<T>(1, 5);
        let w1 = make::<T>(1, 3);
        let y1 = x1.conv1d(&w1, None, 1, 1, 5, 1, 3, 1, 0, 1, 1);
        assert_shape(&y1, (1, 3));

        let x2 = make::<T>(1, 9);
        let w2 = make::<T>(1, 4);
        let y2 = x2.conv2d(&w2, None, 1, 1, 3, 3, 1, 2, 2, (1, 1), (0, 0), (1, 1), 1);
        assert_shape(&y2, (1, 4));
        ...
        let xt = make::<T>(1, 4);
        let wt = make::<T>(1, 4);
        let yt = xt.conv_transpose2d(&wt, None, 1, 1, 2, 2, 1, 2, 2, (1, 1), (0, 0), (0, 0));
        assert_shape(&yt, (1, 9));
